...
!*
	...
	enmPosTime(100, 0, -999999.0f, 6.0f);
	goto Cir00_468 @ 0;
Cir00_448:
	wait(1000);
Cir00_468:
...
sub Girl00()
{
	...
	enmPosTime(30, 0, -999999.0f, 0.0f);
	wait(200);
...
sub Girl01(A B)
{
	...
	enmPosTime(60, 0, -999999.0f, 2.0f);
	wait(60);
	enmPosTime(60, 0, 2.7488935f, 6.0f);
	goto Girl01_332 @ 0;
Girl01_312:
	wait(1000);
Girl01_332:
...
sub Girl02()
{
	...
	enmPosTime(90, 0, -999999.0f, 0.0f);
	wait(230);
	enmDir(-1.5707964f, 0.0f);
	enmPosTime(90, 0, -999999.0f, 1.0f);
6000:
	noop();
	delete();
}
...
sub Girl04(A B)
{
	...
	enmDir(3.1415927f, 4.0f);
	wait(50);
	enmPosTime(100, 0, 0.3926991f, 3.0f);
6000:
	noop();
	return();
}
