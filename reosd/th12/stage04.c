...
sub Girl00(A B)
{
	...
	enmPosTime(60, 0, -999999.0f, 0.0f);
	wait(30);
	callSep("Girl00_at");
	attack(0, -1, -1, "Girl00Dead");
	wait(90);
	enmDir(%ANGLE_PLAYER, 0.0f);
	enmPosTime(60, 0, -999999.0f, 3.0f);
	wait(30);
	[-9985];
	1;
	eqi();
...
sub Girl01()
{
	...
	enmPosTime(40, 0, -999999.0f, 0.0f);
	wait(40);
	callSep("Girl01_at");
	enmDir(1.5707964f, 0.0f);
	enmPosTime(120, 0, 0.0f, 1.0f);
6000:
	noop();
	delete();
}
