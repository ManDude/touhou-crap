...
+60:
    ...
    anmScr(2, 158);
    anm(2);
    setBossFog(160.0f, 16748543);
    life(5000);
    lifebar(0, 5000.0f, -24448);
    playSE(58);
    anmScr(3, 48);
    anmScr(4, 57);
    anmScr(5, 49);
...
sub Boss1_at1()
{
    ...
    etAng(0, 0.0f, 0.0f);
    etSpd_rank(0, 3.0f, 3.0f, 4.0f, 4.4f, 3.5f, 1.5f, 1.5f, 1.5f);
    etNew(1);
    etMode(1, 3);
    etSpr(1, 3, 6);
    etAmt_rank(1, 6, 12, 14, 14, 1, 1, 1, 1);
    etAng(1, 0.0f, 0.0f);
    etSpd_rank(1, 3.0f, 3.0f, 4.0f, 4.4f, 3.5f, 1.5f, 1.5f, 1.5f);
    etNew(2);
    etMode(2, 3);
    etSpr(2, 17, 3);
    etAmt_rank(2, 6, 12, 14, 14, 1, 1, 1, 1);
    etAng(2, 0.0f, 0.0f);
    etSpd_rank(2, 3.0f, 3.0f, 4.0f, 4.4f, 3.5f, 1.5f, 1.5f, 1.5f);
    etNew(3);
    etMode(3, 3);
    etSpr(3, 26, 1);
    etAmt_rank(3, 6, 12, 14, 14, 1, 1, 1, 1);
    etAng(3, 0.0f, 0.0f);
    etSpd_rank(3, 3.0f, 3.0f, 4.0f, 4.4f, 1.5f, 1.5f, 1.5f, 1.5f);
...
sub Boss2_at1()
{
    ...
    etAng(0, 0.0f, 0.0f);
    etSpd(0, 8.0f, 8.0f);
    laserSetSize(0, 0.0f, 512.0f, 16.0f, 16.0f);
    laserSetTime(0, 60, 16, 60, 15, 0);
    etSE(0, 19, -1);
    etOfs(0, -114.0f, 54.0f);
    %B = %FINAL_X + _f(-114);
    %C = %FINAL_Y + _f(54);
    angleToPlayer(%A, %B, %C);
    etAng(0, %A, 0.0f);
...
sub Boss2_at2()
{
    ...
    etSpr(1, 29, 0);
    etAmt(1, $D, 1);
    etAng(1, 0.0f, 0.28559932f);
    etSpd(1, 5.0f, 3.5f);
    etEx(1, 0, 1, 2, 1, -999999, -999999.0f, -999999.0f);
    etEx(1, 1, 0, 268435456, 1, -999999, -999999.0f, -999999.0f);
    setf_rank(%E, 2.0f, 2.0f, 2.0f, 3.0f);
    $D = $D - 1;
    $F = 6000;
...
Boss3_2128:
    ...
    wait(60);
    playSE(28);
    setMoveArea(0.0f, 96.0f, 144.0f, 48.0f);
    anm(2);
    anmScrNoMove(0, 0);
    anmScrSlot(0, 119);
    playSE(31);
...
sub Boss3_at1e2()
{
    ...
    etEx(2, 2, 1, 4, 60, -999999, 0.033333335f, -999.0f);
    %A = -1.5707964f + (%RDEG / _f(16));
    seti_rank($D, 30, 60, 60, 60);
...
sub Boss3_at1e3()
{
    ...
    etAng(3, 0.0f, 0.0f);
    etSpd(3, 1.0f, 0.7f);
    etEx(3, 0, 1, 2, 1, -999999, -999999.0f, -999999.0f);
    etEx(3, 1, 0, 1024, 100, 0, -999999.0f, -999999.0f);
    etEx(3, 2, 1, 4, 60, -999999, 0.033333335f, -999.0f);
    %A = 0.0f + (%RDEG / _f(16));
    seti_rank($D, 30, 60, 60, 60);
...
sub Boss3_at1e4()
{
    ...
    etEx(4, 1, 0, 1024, 100, 0, -999999.0f, -999999.0f);
    etEx(4, 2, 1, 4, 60, -999999, 0.033333335f, -999.0f);
...
Boss4_2148:
    ...
    wait(60);
    enmPos(0.0f, 224.0f);
    enmCir(-1.5707964f, 0.0f, 128.0f, 0.0f);
    $E = 2;
    goto Boss4_3248 @ 0;
Boss4_3040:
    @Boss4_at1e3() async;
...
Boss4_3248:
    ...
    enmCirTime(60, 0, 0.007853982f, -999999.0f, -999999.0f);
    goto Boss4_3560 @ 0;
Boss4_3352:
    @Boss4_at1e3() async;
    wait(40);
...
Boss4_at1e1_1252:
    ...
    etAng(1, 0.0f, 0.0f);
    etSpd_rank(1, 3.0f, 3.0f, 3.0f, 5.0f, 1.2f, 1.2f, 1.2f, 1.2f);
    etEx(1, 0, 1, 2, 1, -999999, -999999.0f, -999999.0f);
    etEx(1, 1, 0, 1024, 100, 0, -999999.0f, -999999.0f);
    etOfs_abs(1, _f(-114) + %FINAL_X, _f(54) + %FINAL_Y);
    etOn(1);
...
Boss4_at1e2_1252:
    ...
    etAng(2, 0.0f, 0.0f);
    etSpd_rank(2, 3.0f, 3.0f, 3.0f, 5.0f, 1.2f, 1.2f, 1.2f, 1.2f);
    etEx(2, 0, 1, 2, 1, -999999, -999999.0f, -999999.0f);
    etEx(2, 1, 0, 1024, 100, 0, -999999.0f, -999999.0f);
    etOfs_abs(2, _f(114) + %FINAL_X, _f(54) + %FINAL_Y);
    etOn(2);
...
Boss4_at1e3_1252:
    ...
    etAng(3, 0.0f, 0.0f);
    etSpd_rank(3, 3.0f, 3.0f, 3.0f, 5.0f, 1.2f, 1.2f, 1.2f, 1.2f);
    etEx(3, 0, 1, 2, 1, -999999, -999999.0f, -999999.0f);
    etEx(3, 1, 0, 1024, 100, 0, -999999.0f, -999999.0f);
    etOfs_abs(3, _f(-64) + %FINAL_X, _f(-80) + %FINAL_Y);
    etOn(3);
...
Boss4_at1e4_1252:
    ...
    etAng(4, 0.0f, 0.0f);
    etSpd_rank(4, 3.0f, 3.0f, 3.0f, 5.0f, 1.2f, 1.2f, 1.2f, 1.2f);
    etEx(4, 0, 1, 2, 1, -999999, -999999.0f, -999999.0f);
    etEx(4, 1, 0, 1024, 100, 0, -999999.0f, -999999.0f);
    etOfs_abs(4, _f(64) + %FINAL_X, _f(-80) + %FINAL_Y);
    etOn(4);
...
!*
    ...
    setMoveArea(0.0f, 128.0f, 200.0f, 64.0f);
    anmScrNoMove(0, 0);
+60:
    anmScrSlot(0, 119);
    wait(60);
    enmPosTime(200, 4, 0.0f, 128.0f);
...
sub BossCard1_at1()
{
    ...
    etAng(0, 0.0f, 0.0f);
    etSpd_rank(0, 2.0f, 2.2f, 2.5f, 2.5f, 1.2f, 1.0f, 1.0f, 1.0f);
    etEx(0, 0, 1, 2, 1, -999999, -999999.0f, -999999.0f);
    etEx(0, 1, 0, 4, 60, -999999, 0.016666668f, -999.0f);
...
sub BossCard1_at1h()
{
    ...
    etAmt_rank(0, 1, 1, 1, 1, 2, 4, 4, 4);
    etAng(0, 0.0f, 0.0f);
    etSpd_rank(0, 2.0f, 2.5f, 2.5f, 2.5f, 1.2f, 1.0f, 1.0f, 1.0f);
    etEx(0, 0, 1, 2, 1, -999999, -999999.0f, -999999.0f);
    etEx(0, 1, 0, 4, 60, -999999, 0.016666668f, -999.0f);
    %A = 3.1415927f + (%RDEG / _f(8));
    %B = _f(80);
...
sub BossCard2_at1(var A, var B, var C)
{
    ...
    etSpd_rank(0, 2.0f, 2.0f, 2.8f, 2.8f, 1.0f, 1.0f, 1.0f, 1.0f);
    etEx(0, 0, 1, 2, 1, -999999, -999999.0f, -999999.0f);
    etDist(0, 16.0f);
    etOfs_abs(0, %B, %C);
    etOn(0);
...
sub BossCard3_at2()
{
    ...
    etSE(0, 19, -1);
    etEx(0, 0, 0, 512, 10, -999999, -999999.0f, -999999.0f);
    etEx(0, 1, 0, 1024, 120, 0, -999999.0f, -999999.0f);
    etEx(0, 2, 1, 8, 60000, -999999, 0.0f, 0.015707964f);
    %A = 2.356194f;
    setf_rank(%E, 128.0f, 64.0f, 64.0f, 64.0f);
    %B = _f(240);
    %C = _f(448);
    $F = 10000;
...
+60:
    ...
    %F1 = _f(-114);
    %F2 = _f(54);
    enmNewRel("BossCard4Laser", -114.0f, 54.0f, 100, 10, 0);
    %F1 = _f(114);
    %F2 = _f(54);
    enmNewRel("BossCard4Laser", 114.0f, 54.0f, 100, 10, 0);
    %F1 = _f(-64);
    %F2 = _f(-80);
    enmNewRel("BossCard4Laser", -64.0f, -80.0f, 100, 10, 0);
    %F1 = _f(64);
    %F2 = _f(-80);
    enmNewRel("BossCard4Laser", 64.0f, -80.0f, 100, 10, 0);
    wait(120);
...
sub BossCard4_at2()
{
    ...
    etSpr(0, 17, 2);
    etAmt(0, 1, 1);
    etAng(0, 0.0f, 0.28559932f);
    etSpd(0, 2.5f, 1.0f);
    etEx(0, 0, 1, 2, 1, -999999, -999999.0f, -999999.0f);
    etEx(0, 1, 0, 256, 1, 15, 0.0f, -999999.0f);
    etEx(0, 2, 0, 268435456, 1, -999999, -999999.0f, -999999.0f);
    setf_rank(%B, 0.033333335f, 0.033333335f, 0.041666668f, 0.05f);
    etEx(0, 4, 0, 4, 60, -999999, %B, -999.0f);
...
BossCard4_at2_628:
    etEx(0, 3, 0, 32, 1, 1, %RDEG / _f(16), %RF * 1.0f);
    etAng(0, %A, 0.0f);
    etOn(0);
!E
    %A = %A + 3.141593f;
...
sub BossCard4_at3()
{
    ...
    etAng(1, 0.0f, 0.7853982f);
    etSpd_rank(1, 2.0f, 2.0f, 2.5f, 3.0f, 1.0f, 1.0f, 1.0f, 1.0f);
    etEx(1, 0, 1, 2, 1, -999999, -999999.0f, -999999.0f);
...
BossCard4_at4_124:
    ...
    %F3 = 0.001164f;
    $I0 = 0;
    enmNewRel("BossCard4Laser2", -114.0f, 54.0f, 100, 10, 0);
    %F1 = _f(114);
    %F2 = _f(54);
    $I0 = 1;
    enmNewRel("BossCard4Laser2", 114.0f, 54.0f, 100, 10, 0);
    ...
    %F2 = _f(-80);
    $I0 = 1;
    enmNewRel("BossCard4Laser2", -64.0f, -80.0f, 100, 10, 0);
    %F1 = _f(64);
    %F2 = _f(-80);
    $I0 = 0;
    enmNewRel("BossCard4Laser2", 64.0f, -80.0f, 100, 10, 0);
...
sub BossCard4_at5()
{
    ...
    etSpr(6, 17, 3);
    etAmt(6, 1, 1);
    etAng(6, 0.0f, 0.62831855f);
    etSpd(6, 2.5f, 1.0f);
    etEx(6, 0, 1, 2, 1, -999999, -999999.0f, -999999.0f);
    etEx(6, 1, 0, 268435456, 1, -999999, -999999.0f, -999999.0f);
    %A = -1.570796f;
...
BossCard4_at6_124:
    ...
    etSpd(7, 3.0f, 1.0f);
    etEx(7, 0, 1, 2, 1, -999999, -999999.0f, -999999.0f);
    etOn(7);
    wait(20);
BossCard4_at6_368:
...
BossCard4_at7_308:
    ...
    etSpd(7, (%RF * 2.0f) + 0.5f, 1.0f);
    etEx(7, 0, 1, 2, 1, -999999, -999999.0f, -999999.0f);
    etEx(7, 1, 0, 268435456, 1, -999999, -999999.0f, -999999.0f);
    %B = (%RF * _f(128)) + _f(64);
    etSpd(7, (%B / 64.0f) + (%RF * 0.5f), 0.0f);
...
sub BossCard5()
{
    ...
    $BOMB_COUNT = 0;
    stageProg(44);
    enmPosTime(120, 4, 160.0f, 128.0f);
...
BossCard5_at_712:
    ...
    etEx(0, 2, 0, 4096, 160, -999999, -999999.0f, -999999.0f);
    $L = 61;
    goto BossCard5_at_1692 @ 0;
BossCard5_at_1340:
    etAng(0, %K, 0.0f);
    etEx(0, 3, 0, 4, 60, -999999, 0.023333333f, -999.0f);
    etOfs_abs(0, %A, %B);
    etOn(0);
    %A = %A + %E;
    %B = %B + %F;
...
sub BossCard6_at(var A, var B, var C, var D, var E, var F, var G)
{
    ...
    etSpd_rank($A, 1.5f, 1.5f, 1.7f, 1.8f, 1.0f, 1.0f, 1.0f, 1.0f);
    etEx($A, 0, 1, 2, 1, -999999, -999999.0f, -999999.0f);
    etEx($A, 1, 0, 2097152, $G, -999999, -999999.0f, -999999.0f);
    etEx($A, 2, 0, 268435456, 1, -999999, -999999.0f, -999999.0f);
    etEx($A, 3, 0, 512, 300, -999999, -999999.0f, -999999.0f);
    etEx($A, 4, 0, 1024, 1600, 0, -999999.0f, -999999.0f);
...
BossCard6_at_676:
    ...
    etEx($A, 7, 1, 8, 60000, -999999, 0.0f, %D / 4.8f);
    etOfs_abs($A, %B, %C);
    etOn($A);
    $I2 = $G;
    enmNew("BossCard6_atLine", %B, %C, 100, 100, 0);
    return();
}
