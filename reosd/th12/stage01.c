...
40:
!*
	enmPosTime(80, 0, -0.3926991f, 2.0f);
120:
	enmPosTime(100, 0, 1.5707964f, 2.0f);
10000:
	return();
}
...
100:
!*
	enmPosTime(100, 0, 3.5342917f, 2.0f);
10000:
	return();
}
...
130:
	enmPosTime(60, 0, 4.712389f, 5.0f);
190:
	enmPosTime(9810, 0, 4.712389f, 495.5f);
1000:
	return();
}
